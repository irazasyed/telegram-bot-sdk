 ...
 * @property string|null $text (Optional). Brief description of the game or high scores
 ...
 * @property Animation|null $animation (Optional). Animation that will be displayed in the game
